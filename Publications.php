...
<body>
    ...
    <div class="breadcrumb-area">
        <div class="breadcrumb-top default-overlay bg-img pt-100 pb-95"
            style="background-image:url(images/publications.jpg);">
            <div class="container">
                <h2>PUBLICATIONS</h2>
        ...
        <div class="breadcrumb-bottom">
            <div class="container">
                <ul>
                    <li><a href="index.php">Home</a> <span><i class="fa fa-angle-double-right"></i> DEPARTMENTS</span>
                    </li>
                </ul>
            </div>
        </div>
                            ...
                            <table class="table table-stripped mb-0">
                                <tbody>
                                    <tr class="d-flex justify-content-between">
                                        <td> <span>1</span> <strong class="mx-5 py-3"> Central Asia: It’s Geo-economic
                                                Importance for the World. </strong></td>
                                        <td class="mx-5 py-3"> <a
                                                class="animated default-btn btn-green-color text-decoration-none"
                                                href="http://www.hamrc.org/pdf/research_paper1.pdf"> Download </a> </td>
                                    </tr>
                                    <tr class="d-flex justify-content-between">
                                        <td> <span>2</span> <strong class="mx-5 py-3"> India’s Energy Security
                                                Challenges: Role of Central Asia. </strong></td>
                                        <td class="mx-5 py-3"> <a
                                                class="animated default-btn btn-green-color text-decoration-none"
                                                href="http://www.hamrc.org/pdf/research_paper3.pdf"> Download </a> </td>
                                    </tr>
                                    <tr class="d-flex justify-content-between">
                                        <td> <span>3</span> <strong class="mx-5 py-3"> UN role in the World Affairs.
                                            </strong></td>
                                        <td class="mx-5 py-3"> <a
                                                class="animated default-btn btn-green-color text-decoration-none"
                                                href="http://www.hamrc.org/pdf/research_paper2.pdf"> Download </a> </td>
                                    </tr>
                                    <tr class="d-flex justify-content-between">
                                        <td> <span>4</span> <strong class="mx-5 py-3"> Management Of Dushtavrana By
                                                Vranakarma Followed By Skin Grafting. </strong></td>
                                        <td class="mx-5 py-3"> <a
                                                class="animated default-btn btn-green-color text-decoration-none"
                                                href="http://www.hamrc.org/pdf/research_paper4.pdf"> Download </a> </td>
                                    </tr>
                                </tbody>
                            </table>
                        </div>
