...
<body>
    ...
    <div class="breadcrumb-area">
        ...
        <div class="breadcrumb-bottom">
            <div class="container">
                <ul>
                    <li><a href="index.php">Home</a> <span><i class="fa fa-angle-double-right"></i> HOSPITAL</span>
                    </li>
                </ul>
            </div>
        </div>
                            ...
                            <table class="table table-stripped mb-0">
                                <tbody>
                                    <tr class="d-flex justify-content-between">
                                        <td> <span>1</span> <strong class="mx-5 py-3"> OPD Details </strong></td>
                                        <td class="mx-5 py-3"> <a
                                                class="animated default-btn btn-green-color text-decoration-none"
                                                href="http://www.hamrc.org/pdf/hamrc_opd.pdf"> Download </a> </td>
                                    </tr>
                                    <tr class="d-flex justify-content-between">
                                        <td> <span>2</span> <strong class="mx-5 py-3"> IPD Details </strong></td>
                                        <td class="mx-5 py-3"> <a
                                                class="animated default-btn btn-green-color text-decoration-none"
                                                href="http://www.hamrc.org/pdf/hamrc_ipd.pdf"> Download </a> </td>
                                    </tr>
                                    <tr class="d-flex justify-content-between">
                                        <td> <span>3</span> <strong class="mx-5 py-3"> Clinical Material
                                            </strong></td>
                                        <td class="mx-5 py-3"> <a
                                                class="animated default-btn btn-green-color text-decoration-none"
                                                href="http://www.hamrc.org/pdf/clinical_material.pdf"> Download </a>
                                        </td>
                                    </tr>
                                </tbody>
                            </table>
