...
<head>
    ...
    <title>recognition & Affiliation</title>
...
<body>
    ...
    <div class="breadcrumb-area">
        <div class="breadcrumb-top default-overlay bg-img pt-100 pb-95"
            style="background-image:url(images/recognition_affiliation.jpg);">
            <div class="container">
                <h2>RECOGNITION & AFFILIATION</h2>
        ...
        <div class="breadcrumb-bottom">
            <div class="container">
                <ul>
                    <li><a href="index.php">Home</a> <span><i class="fa fa-angle-double-right"></i> RECOGNITION & AFFILIATION </span>
                    </li>
                </ul>
            </div>
        </div>
