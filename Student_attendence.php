...
<head>
    ...
    <title>Studens Attendence</title>
...
<body>
    ...
    <div class="breadcrumb-area">
        <div class="breadcrumb-top default-overlay bg-img pt-100 pb-95"
            style="background-image:url(images/students_attendence.jpg);">
            <div class="container">
        ...
        <div class="breadcrumb-bottom">
            <div class="container">
                <ul>
                    <li><a href="index.php">Home</a> <span><i class="fa fa-angle-double-right"></i> STUDENTS ATTENDENCE </span>
                    </li>
                </ul>
            </div>
        </div>
            ...
            <div class="row">
                <div class="">
                    <div class="about-content">
                        ...
                        <hr>
                        <strong> Online Classes are Conducted due to COVID-19 </strong>
                    </div>
                </div>
            </div>
        </div>
